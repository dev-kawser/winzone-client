        ...
        <footer className="bg-white dark:bg-gray-900 mt-10">
            <div className="container px-6 py-12 mx-auto">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link to="/">
                        <img className="h-20 w-20 border-4 rounded-full" src="https://i.ibb.co/Yjm8Wx5/golden-trophy-with-falling-golden-confetti.jpg" alt="" />
                    </Link>
                    <h2 className="font-bold ubuntu text-lg lg:text-[27px] text-white">WinZone</h2>
                    </div>

                    <div className="flex -mx-2">

                        <a href="https://www.facebook.com/kawserferdoussafi.03" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Facebook">
                        ...
                        <a href="https://www.linkedin.com/in/kawser-ferdous-safi/" target="_blank" className="mx-2 text-[28px] text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
                            <FaLinkedin />
                        </a>
                    </div>
                </div>
                ...
                <footer className="py-5 text-center  dark:text-white">
