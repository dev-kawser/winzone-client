        ...
        <footer className="bg-white dark:bg-gray-900 mt-10">
            <div className="container px-6 py-12 mx-auto">
                ...
                <div className="flex items-center justify-between">
                    <Link to="/">
                        <img className="w-auto h-20" src="https://i.ibb.co/7XhJX5x/w-removebg-preview.png" alt="" />
                    </Link>
                    ...
                    <div className="flex -mx-2">
                        ...
                        <a href="https://www.linkedin.com/in/kawser-ferdous-safi/" target="_blank" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Github">
                            <FaLinkedin />
                        </a>
                    </div>
                </div>
