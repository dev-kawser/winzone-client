                ...
                <div className="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="mb-4">
                            ...
                            <input type="email" id="email" name="email" className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" {...register("email", { required: true })} />
