              ...
              <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex items-center">
                  ...
                  <div className="relative w-full">
                    ...
                    <input type="text" name="search" className=" border text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 bg-white border-gray-600" placeholder="Search photos by tags (e.g., Image Design 
Contests, Article Writing, Marketing Strategy)" required {...register("search")} />
                    <button type="button" className="flex absolute inset-y-0 right-0 items-center pr-3">
                    </button>
                  </div>
                  <button type="submit" className="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white rounded-lg border hover:scale-105 transition-all focus:ring-4 focus:outline-none bg-[#d32f2f]"><svg className="mr-2 -ml-1 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>Search</button>
                </form>
